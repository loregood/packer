...
This repository builds Vagrant box images from an OpenBSD ISO release install CD's -- using HashiCorp Packer and Vagrant.
...
I recommend Sun's err Oracle's... VirtualBox for local development, since it's free and it works on Linux, Mac and Windows.
